...
__all__ = ["Base", "Genre", "Author", "Language", "Chapter", "Manga", "GenreManga"]
...
class Author(Base):
    ...
    manga: Mapped[List["Manga"]] = relationship("Manga", back_populates="author")
...
class Language(Base):
    ...
    manga: Mapped[List["Manga"]] = relationship("Manga", back_populates="language")
...
class Manga(Base):
    ...
    language: Mapped["Language"] = relationship("Language", back_populates="manga")

    author: Mapped["Author"] = relationship("Author", back_populates="manga")
...
class GenreManga(Base):
    ...
    manga: Mapped["Manga"] = relationship("Manga", back_populates="genre_links")

    genre: Mapped["Genre"] = relationship("Genre", back_populates="manga_list")
